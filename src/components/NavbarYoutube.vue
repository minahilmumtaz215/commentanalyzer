<template>
  <nav class="navbar">
    <div class="nav-items">
      <div class="title" @click="$router.push('/')"><strong>Comment Analyzer</strong></div>
...
.navbar {
  width: 100vw;
  height: 60px;
  background: linear-gradient(to right,rgb(79, 3, 3) 0%,rgb(126, 5, 5) 60%,rgb(251, 183, 183) 90%, #ffffff 100%);
  display: flex;
  align-items: center;
  padding: 0 40px;
